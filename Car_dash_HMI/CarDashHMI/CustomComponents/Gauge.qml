...
Item{
    ...
    property color primaryColor: "#E50914"
    property color accentGlowColor: "#FF1E27"
    ...
    Item {
        ...
        Rectangle {
            ...
            RadialGradient {
                ...
                gradient: Gradient {
                    ...
                    GradientStop {
                        position: 1.0
                        color: alertThemeActivate  ? "#FF1E00" : primaryColor
                    }
                }
            }
        }
        ...
        OpacityMask {
            ...
            opacity: alertThemeActivate  ? 7.5 : 0.75
            maskSource: Image {
                id: name
                source: "qrc:/Assets/Images/Gauge/Gauge.png"
            }
    ...
    PathView {
        ...
        delegate: Text {
            ...
            color: alertThemeActivate  ? "#FF4D4D" : primaryColor
    ...
    Rectangle{
        ...
        Rectangle{
            ...
            ColorAnimation on color { to: "#FF0033"; duration: 600 ;running: alertThemeActivate }
            ColorAnimation on color { to: primaryColor; duration: 600 ;running: !alertThemeActivate }
        }
        ...
        RectangularGlow {
            ...
            glowRadius: 50
            spread: 0.5
            opacity: alertThemeActivate  ? 0.35 : 0.65
            ...
            ColorAnimation on color { to: "#FF0033"; duration: 600 ;running: alertThemeActivate }
            ColorAnimation on color { to: accentGlowColor; duration: 600 ;running: !alertThemeActivate }
        }
        ...
        Image {
            ...
            LinearGradient {
                ...
                gradient: Gradient {
                    ...
                    GradientStop { position: 1.0; color: alertThemeActivate ? "#FF0000" : primaryColor }
                }
            }
        }
    }
